    ...
    var body: some Scene {
        ...
        .commands {
            ...
            CommandGroup(replacing: .toolbar) {
                ...
                Menu("Letter Color") {
                    Button {
                        gameEngine.switchLetterColor(to: .green)
                    } label: {
                        if gameEngine.letterColor == .green {
                            Text("✓ Green")
                        } else {
                            Text("   Green")
                        }
                    ...
                    Button {
                        gameEngine.switchLetterColor(to: .amber)
                    } label: {
                        if gameEngine.letterColor == .amber {
                            Text("✓ Amber")
                        } else {
                            Text("   Amber")
                        }
                    ...
                    Button {
                        gameEngine.switchLetterColor(to: .white)
                    } label: {
                        if gameEngine.letterColor == .white {
                            Text("✓ White")
                        } else {
                            Text("   White")
                        }
